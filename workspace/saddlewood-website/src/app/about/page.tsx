...
export default function AboutPage() {
  ...
  return (
    <div className="pb-20 md:pb-0">
      <div className="relative bg-gradient-subtle overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-24 md:py-32">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-semibold text-primary mb-8">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div>
              ...
              <div className="space-y-5 text-primary/60 leading-relaxed">
                <p>
              ...
              <div className="mt-10 pt-10 border-t border-sandstone flex flex-wrap gap-10">
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-taupe mt-1">Trade Licenses</p>
                </div>
                <div className="h-12 w-px bg-sandstone"></div>
                <div className="text-center">
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-4 -right-4 bg-gold text-white px-8 py-4 rounded-xl font-semibold shadow-gold">
                Since 2007
              </div>
            </div>
          </div>
      ...
      <section className="py-24 bg-ivory">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-18">
            <span className="text-taupe uppercase tracking-[0.2em] text-sm font-medium">How We Work</span>
            <h2 className="font-serif text-3xl md:text-4xl font-semibold mt-4 text-primary">Our Process</h2>
            <p className="text-primary/60 mt-5 max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
            {processSteps.map((item, index) => (
              <div key={index} className="relative">
                <div className="bg-white p-10 rounded-2xl shadow-soft hover:shadow-lift hover:-translate-y-1 transition-all duration-300 h-full border border-sandstone/50">
                  <div className="flex items-center justify-between mb-8">
                    <div className="w-16 h-16 rounded-full bg-ivory flex items-center justify-center text-gold">
                      {item.icon}
                    </div>
      ...
      <section className="py-24 bg-sandstone-light">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-18">
            <span className="text-gold uppercase tracking-[0.2em] text-sm font-medium">Meet the Team</span>
            <h2 className="font-serif text-3xl md:text-4xl font-semibold mt-4 text-primary">The People Behind the Work</h2>
            <p className="text-primary/60 mt-5 max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            {[
              ...
              <div key={index} className="text-center p-10 bg-white rounded-2xl shadow-soft border border-sandstone/50">
                <div className="w-40 h-40 mx-auto mb-8 rounded-full bg-ivory border border-gold/20 flex items-center justify-center">
                ...
                <h3 className="text-xl font-semibold text-primary mb-3">{member.role}</h3>
                <p className="text-primary/60 text-sm">{member.desc}</p>
          ...
          <div className="mt-14 text-center">
            <p className="text-taupe mb-8">Follow us to see our team in action</p>
            <div className="flex justify-center gap-4">
              <a 
                href="https://www.instagram.com/saddlewood_contracting/" 
                target="_blank" 
                rel="noopener noreferrer"
                className="inline-flex items-center px-8 py-4 bg-gold text-white rounded-xl hover:bg-gold-dark transition-colors shadow-gold"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="inline-flex items-center px-8 py-4 bg-white text-primary rounded-xl border border-taupe/30 hover:border-gold/50 transition-colors"
              >
                <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <span className="text-taupe uppercase tracking-[0.2em] text-sm font-medium">Got Questions?</span>
            <h2 className="font-serif text-3xl md:text-4xl font-semibold mt-4 text-primary">Frequently Asked Questions</h2>
          </div>
          
          <div className="space-y-5">
            {faqs.map((faq, index) => (
              <div key={index} className="border border-sandstone rounded-2xl overflow-hidden">
                <details className="group">
                  <summary className="flex items-center justify-between p-8 cursor-pointer bg-ivory hover:bg-sandstone-light/50 transition-colors">
                    <h3 className="font-semibold text-primary pr-6">{faq.question}</h3>
                  ...
                  <div className="p-8 bg-white">
                    <p className="text-primary/60 leading-relaxed">{faq.answer}</p>
                  </div>
                </details>
              </div>
            ))}
