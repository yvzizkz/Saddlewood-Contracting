  ...
  return (
    <div className="pb-20 md:pb-0">
      <div className="relative bg-gradient-subtle overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-24 md:py-32">
          <div className="text-center max-w-3xl mx-auto">
            <span className="inline-block text-silver-dark uppercase tracking-[0.25em] text-sm font-medium mb-8">
              Our Story
            </span>
            <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-semibold text-text-primary mb-8">
              Building <span className="text-gold">Trust</span> Since 2007
            </h1>
      ...
      <section className="py-24 bg-surface">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div>
              <span className="text-gold uppercase tracking-[0.2em] text-sm font-medium">Who We Are</span>
              ...
              <div className="mt-10 pt-10 border-t border-border-default flex flex-wrap gap-10">
                <div className="text-center">
                  <p className="text-3xl font-serif text-gold">18+</p>
                  <p className="text-sm text-silver-dark mt-1">Years Experience</p>
                </div>
                <div className="h-12 w-px bg-border-default"></div>
                <div className="text-center">
                  <p className="text-3xl font-serif text-gold">4</p>
                  <p className="text-sm text-silver-dark mt-1">Trade Licenses</p>
                </div>
                <div className="h-12 w-px bg-border-default"></div>
                <div className="text-center">
                  <p className="text-3xl font-serif text-text-primary">Family</p>
                  <p className="text-sm text-silver-dark mt-1">Owned & Operated</p>
                </div>
              </div>
            </div>

            <div className="relative">
              <div className="aspect-[3/4] bg-obsidian rounded-2xl overflow-hidden relative border border-border-default shadow-soft">
                <Image
              ...
              <div className="absolute -bottom-4 -right-4 bg-gold text-text-inverse font-semibold px-8 py-4 rounded-xl shadow-gold">
                Since 2007
              </div>
            </div>
          </div>
      ...
      <section className="py-24 bg-obsidian">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-18">
            <span className="text-silver-dark uppercase tracking-[0.2em] text-sm font-medium">How We Work</span>
            <h2 className="font-serif text-3xl md:text-4xl font-semibold mt-4 text-text-primary">Our Process</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
            {processSteps.map((item, index) => (
              <div key={index} className="relative">
                <div className="bg-surface p-10 rounded-2xl shadow-soft hover:shadow-lift hover:-translate-y-1 transition-all duration-300 h-full border border-border-default">
                  <div className="flex items-center justify-between mb-8">
                    <div className="w-16 h-16 rounded-full bg-surface-light flex items-center justify-center text-gold">
                      {item.icon}
                    </div>
                    <span className="text-4xl font-serif text-gold/20 font-bold">{item.step}</span>
                  </div>
      ...
      <section className="py-24 bg-surface-light">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-18">
            <span className="text-gold uppercase tracking-[0.2em] text-sm font-medium">Meet the Team</span>
            <h2 className="font-serif text-3xl md:text-4xl font-semibold mt-4 text-text-primary">The People Behind the Work</h2>
            <p className="text-text-secondary mt-5 max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            <div className="text-center p-10 bg-surface rounded-2xl shadow-soft border border-border-default">
              <div className="w-40 h-40 mx-auto mb-8 rounded-full bg-surface-light border border-gold/20 overflow-hidden relative">
                <Image
              ...
              <h3 className="text-xl font-semibold text-text-primary mb-1">Leadership</h3>
              <p className="text-text-primary font-medium mb-3">Marco Cravioto</p>
              <p className="text-text-secondary text-sm">Guiding vision and client relationships</p>
            </div>
            {[
              ...
              <div key={index} className="text-center p-10 bg-surface rounded-2xl shadow-soft border border-border-default">
                <div className="w-40 h-40 mx-auto mb-8 rounded-full bg-surface-light border border-gold/20 flex items-center justify-center">
                ...
                <h3 className="text-xl font-semibold text-text-primary mb-3">{member.role}</h3>
                <p className="text-text-secondary text-sm">{member.desc}</p>
                <p className="text-gold/50 text-xs mt-4 italic">Photo coming soon</p>
              </div>
            ))}
          </div>

          <div className="mt-14 text-center">
            <p className="text-silver-dark mb-8">Follow us to see our team in action</p>
            <div className="flex justify-center gap-4">
              <a
                href="https://www.instagram.com/saddlewood_contracting/"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center px-8 py-4 bg-gold text-text-inverse font-semibold rounded-xl hover:bg-gold-dark transition-colors shadow-gold"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center px-8 py-4 bg-surface text-text-primary rounded-xl border border-border-default hover:border-gold/50 transition-colors"
              >
                <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
      ...
      <section className="py-24 bg-surface">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <span className="text-silver-dark uppercase tracking-[0.2em] text-sm font-medium">Got Questions?</span>
            <h2 className="font-serif text-3xl md:text-4xl font-semibold mt-4 text-text-primary">Frequently Asked Questions</h2>
          </div>

          <div className="space-y-5">
            {faqs.map((faq, index) => (
              <div key={index} className="border border-border-default rounded-2xl overflow-hidden">
                <details className="group">
                  <summary className="flex items-center justify-between p-8 cursor-pointer bg-surface-light hover:bg-surface-raised/50 transition-colors">
                    <h3 className="font-semibold text-text-primary pr-6">{faq.question}</h3>
      ...
      <section className="py-24 bg-surface-light">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="font-serif text-3xl font-semibold mt-4 mb-8 text-text-primary">
