      ...
      <div className="bg-gradient-subtle py-24 relative overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          <div className="flex flex-col items-center text-center">
            <div className="mb-8">
              <div className="w-32 h-32 md:w-40 md:h-40 rounded-full border border-sandstone flex items-center justify-center bg-white shadow-soft">
                <Image
                  src="/images/logo.png"
            ...
            <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-semibold mb-5 text-primary">
            ...
            <div className="mt-10 flex flex-wrap justify-center gap-8 text-center">
              <div className="flex items-center gap-2">
                ...
                <span className="text-primary text-sm">No Obligation</span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-5 h-5 text-sage-dark" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                </svg>
                <span className="text-primary text-sm">Response Within 24 Hours</span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-5 h-5 text-sage-dark" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                </svg>
                <span className="text-primary text-sm">Licensed & Insured</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          <div>
            <div className="mb-12">
              ...
              <h2 className="font-serif text-3xl font-semibold mt-3 text-primary">
            ...
            <div className="space-y-8 mb-12">
              <div className="flex items-start">
                <div className="w-14 h-14 rounded-xl bg-ivory flex items-center justify-center mr-5 flex-shrink-0">
                ...
                <div>
                  ...
                  <p className="text-primary/60 text-sm">Paradise Valley, Scottsdale, Phoenix, Arcadia, Fountain Hills, and select Valley communities</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href="mailto:info@saddlewoodcontracting.com" className="text-primary/60 hover:text-gold transition-colors">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-primary/60 text-sm">Monday - Friday: 7am - 5pm</p>
                  <p className="text-primary/60 text-sm">Saturday: 8am - 3pm</p>
                  <p className="text-primary/60 text-sm">Sunday: Closed</p>
                </div>
              </div>
            </div>
            
            <div className="bg-sage/10 rounded-2xl p-8 border border-sage/20">
              <h3 className="font-semibold text-sage-dark mb-5 uppercase tracking-wider text-sm">Fully Licensed & Insured</h3>
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div className="flex justify-between">
                  <span className="text-primary/60">HVAC</span>
                  <span className="text-sage-dark font-medium">ROC 350714</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-primary/60">Electrical</span>
                  <span className="text-sage-dark font-medium">ROC 350715</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-primary/60">Plumbing</span>
                  <span className="text-sage-dark font-medium">ROC 350716</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-primary/60">General</span>
                  <span className="text-sage-dark font-medium">ROC 305762</span>
                </div>
              </div>
            </div>
            ...
            <div className="mt-10 flex gap-3">
              <a 
                ...
                className="w-12 h-12 rounded-xl bg-sandstone flex items-center justify-center hover:bg-gold/20 transition-colors group"
              >
                <svg className="w-5 h-5 text-taupe group-hover:text-gold transition-colors" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            <div className="bg-white rounded-2xl shadow-soft-lg border border-sandstone overflow-hidden">
              <div className="bg-primary p-8">
                <h3 className="text-white font-semibold text-lg">Request a Consultation</h3>
                <p className="text-taupe-light text-sm mt-1">We typically respond within one business day</p>
              </div>
