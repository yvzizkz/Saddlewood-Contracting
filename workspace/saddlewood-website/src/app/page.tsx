      ...
      <section className="py-20 sm:py-24 bg-white">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-8 bg-white rounded-2xl shadow-soft border border-sandstone-light/50 hover:shadow-soft-lg transition-all duration-300 relative overflow-hidden">
              <div className="absolute -right-4 -top-4 w-24 h-24 rounded-full bg-coral/5"></div>
              <div className="w-20 h-20 mx-auto mb-6 rounded-2xl bg-gradient-to-br from-desert to-sandstone-light flex items-center justify-center shadow-soft">
                <span className="text-terracotta text-2xl font-serif font-bold">18+</span>
              </div>
            ...
            <div className="text-center p-8 bg-white rounded-2xl shadow-soft border border-sandstone-light/50 hover:shadow-soft-lg transition-all duration-300 relative overflow-hidden">
              <div className="absolute -right-4 -top-4 w-24 h-24 rounded-full bg-sage/10"></div>
              <div className="w-20 h-20 mx-auto mb-6 rounded-2xl bg-gradient-to-br from-sage-light/30 to-sage/20 flex items-center justify-center shadow-soft">
            ...
            <div className="text-center p-8 bg-white rounded-2xl shadow-soft border border-sandstone-light/50 hover:shadow-soft-lg transition-all duration-300 relative overflow-hidden">
              <div className="absolute -right-4 -top-4 w-24 h-24 rounded-full bg-accent/5"></div>
              <div className="w-20 h-20 mx-auto mb-6 rounded-2xl bg-gradient-to-br from-desert to-sandstone-light flex items-center justify-center shadow-soft">
