            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="text-center p-6 border border-gray-100 rounded-xl">
                  <p className="text-gray-500 text-sm uppercase tracking-wider mb-2">Panel & EV Charging</p>
                  <p className="text-3xl font-serif font-semibold text-charcoal">$8K - $35K</p>
                  <p className="text-gray-500 text-sm mt-2">Service upgrades & charging stations</p>
                </div>
                <div className="text-center p-6 border border-gold/30 rounded-xl bg-gold/5">
                  <p className="text-gold text-sm uppercase tracking-wider mb-2">Complete Smart Home</p>
                  <p className="text-3xl font-serif font-semibold text-charcoal">$50K - $200K+</p>
                  <p className="text-gray-500 text-sm mt-2">Full automation & lighting design</p>
                </div>
              </div>
