...
export const metadata: Metadata = {
  ...
  description: 'Premium electrical services in Phoenix - smart home integration, architectural lighting, and complete electrical solutions. Licensed & insured (ROC #350715).',
};
...
export default function ElectricalPage() {
  const electricalSchemaData = {
    ...
    "serviceType": "Electrical Installation and Smart Home Integration",
    "provider": {
      "@type": "LocalBusiness",
            ...
            <div className="flex flex-col lg:flex-row items-center gap-16">
              ...
              <div className="text-center lg:text-left flex-1">
                ...
                <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-semibold mb-8 text-primary">
                  Expert <span className="text-gold">Electrical</span> Solutions
                </h1>
                <p className="text-lg text-primary/70 max-w-2xl mb-10">
                  From architectural lighting to complete smart home integration. Power and elegance, perfectly combined.
                </p>
            ...
            <div className="mt-16 pt-10 border-t border-taupe/20">
              <div className="flex flex-wrap justify-center lg:justify-start gap-10 text-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-taupe mt-1">#350715</p>
                </div>
                <div className="h-12 w-px bg-taupe/20 hidden sm:block"></div>
                <div>
        ...
        <div className="py-20 sm:py-26 bg-white">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                { title: "Smart Home Integration", desc: "Seamlessly connect lighting, security, and automation systems. Control your entire home from one interface." },
                { title: "Architectural Lighting", desc: "Designer lighting solutions that highlight your home's best features. Layered illumination for every mood." },
                { title: "Electrical Upgrades", desc: "Panel upgrades, whole-home rewiring, and EV charging stations. Modern power for modern living." }
              ].map((service, i) => (
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <blockquote className="text-center">
              <p className="text-2xl md:text-3xl font-serif text-primary leading-relaxed mb-8">
                "The smart home integration was seamless. Everything works together beautifully—lighting, 
                security, climate—all controllable from one app."
              </p>
              <footer>
                <cite className="not-italic">
                  <span className="text-gold font-medium">David & Michelle R.</span>
                  <span className="text-taupe mx-3">|</span>
                  <span className="text-taupe">Paradise Valley</span>
                </cite>
              </footer>
            </blockquote>
          </div>
        ...
        <div className="py-16 sm:py-20 bg-ivory">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row items-center justify-between gap-8 p-8 bg-white rounded-2xl shadow-soft mb-10 border border-sandstone">
              <div className="flex items-center gap-5">
                <div className="bg-sage/20 text-sage-dark px-5 py-4 rounded-xl text-center">
                  ...
                  <span className="font-bold text-sage-dark">350715</span>
                </div>
                <div>
                  <p className="font-semibold text-primary">CR-11 Licensed</p>
                  <p className="text-sm text-taupe">Electrical Contracting</p>
                </div>
              </div>
              <Link 
                href="/license-info" 
            ...
            <div className="text-center p-10 border border-sandstone rounded-2xl bg-white shadow-soft">
              ...
              <p className="text-primary/60 mb-8 max-w-lg mx-auto">View our smart home integrations and electrical projects that power Arizona's finest homes.</p>
              <Link 
                href="/gallery" 
