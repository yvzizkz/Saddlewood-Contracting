            ...
            <div className="flex flex-col lg:flex-row items-center gap-12">
              ...
              <div className="text-center lg:text-left flex-1">
                <div className="flex items-center justify-center lg:justify-start gap-3 mb-4">
                  ...
                  <span className="text-gold uppercase tracking-[0.3em] text-sm font-medium">Custom Plumbing</span>
                  <div className="h-px w-8 bg-gold/50"></div>
                </div>
                ...
                <p className="text-xl text-gray-300 max-w-2xl mb-8">
                  Elevate your daily rituals with custom plumbing craftsmanship. Where function flows with beauty.
                </p>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <blockquote className="text-center">
              <p className="text-2xl md:text-3xl font-serif text-white leading-relaxed mb-6">
                "Our master bathroom is now a true sanctuary. The steam shower, 
                soaking tub, and heated floors make every day feel like a spa retreat."
              </p>
              <footer>
