...
export const metadata: Metadata = {
  title: 'Plumbing Services | Luxury Fixtures & Water Systems | Saddlewood Contracting',
  description: 'Premium plumbing services in Phoenix - luxury fixture installation, water treatment systems, and sophisticated bathroom design. Licensed & insured (ROC #350716).',
};
...
export default function PlumbingPage() {
  const plumbingSchemaData = {
    ...
    "serviceType": "Plumbing Installation, Repair, and Water Systems",
    "provider": {
      "@type": "LocalBusiness",
            ...
            <div className="flex flex-col lg:flex-row items-center gap-16">
              ...
              <div className="text-center lg:text-left flex-1">
                ...
                <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-semibold mb-8 text-primary">
                  Premium <span className="text-gold">Plumbing</span> Solutions
                </h1>
                <p className="text-lg text-primary/70 max-w-2xl mb-10">
                  Thoughtful plumbing installations and expert repairs. From fixture upgrades to whole-home water treatment systems.
                </p>
            ...
            <div className="mt-16 pt-10 border-t border-taupe/20">
              <div className="flex flex-wrap justify-center lg:justify-start gap-10 text-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-taupe mt-1">#350716</p>
                </div>
                <div className="h-12 w-px bg-taupe/20 hidden sm:block"></div>
                <div>
        ...
        <div className="py-20 sm:py-26 bg-white">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                { title: "Luxury Fixtures", desc: "Premium faucets, fixtures, and hardware from the world's finest brands. Installed with precision and care." },
                { title: "Water Treatment", desc: "Whole-home water filtration and softening systems. Pure, crystal-clear water from every tap." },
                { title: "Bathroom Design", desc: "Spa-inspired bathrooms with thoughtful plumbing solutions. Steam showers, soaking tubs, and more." }
              ].map((service, i) => (
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <blockquote className="text-center">
              <p className="text-2xl md:text-3xl font-serif text-primary leading-relaxed mb-8">
                "Our new master bathroom feels like a five-star spa. The attention to detail in every 
                fixture and fitting was impeccable."
              </p>
              <footer>
                <cite className="not-italic">
                  <span className="text-gold font-medium">Robert & Maria K.</span>
                  <span className="text-taupe mx-3">|</span>
                  <span className="text-taupe">Fountain Hills</span>
                </cite>
              </footer>
            </blockquote>
          </div>
        ...
        <div className="py-16 sm:py-20 bg-ivory">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row items-center justify-between gap-8 p-8 bg-white rounded-2xl shadow-soft mb-10 border border-sandstone">
              <div className="flex items-center gap-5">
                <div className="bg-sage/20 text-sage-dark px-5 py-4 rounded-xl text-center">
                  ...
                  <span className="font-bold text-sage-dark">350716</span>
                </div>
                <div>
                  <p className="font-semibold text-primary">CR-37 Licensed</p>
                  <p className="text-sm text-taupe">Plumbing Contracting</p>
                </div>
              </div>
              <Link 
                href="/license-info" 
            ...
            <div className="text-center p-10 border border-sandstone rounded-2xl bg-white shadow-soft">
              ...
              <p className="text-primary/60 mb-8 max-w-lg mx-auto">View our premium plumbing installations and bathroom transformations.</p>
              <Link 
                href="/gallery" 
