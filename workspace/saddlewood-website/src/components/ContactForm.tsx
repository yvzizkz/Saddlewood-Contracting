...
export default function ContactForm() {
  ...
  return (
    <div className="shadow-lg rounded-2xl bg-surface p-8 border-t-4 border-gold">
      <h3 className="text-2xl font-bold mb-6 text-text-primary">Request A Free Estimate</h3>

      {formStatus.error ? (
        <div className="bg-red-900/30 text-red-400 p-4 rounded-lg mb-6 shadow-sm border-l-4 border-red-500">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="mb-1">
            <label htmlFor="name" className="block text-text-secondary font-medium mb-2 flex items-center">
            ...
            <div className="relative">
              <input
                ...
                className={`w-full px-4 py-3 border-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-gold transition-colors bg-surface-light text-text-primary placeholder-silver-dark
                  ${errors.name ? 'border-red-500 bg-red-900/20' : touchedFields.name ? 'border-green-500 bg-green-900/20' : 'border-border-default'}`}
              />
          ...
          <div className="mb-1">
            <label htmlFor="email" className="block text-text-secondary font-medium mb-2 flex items-center">
            ...
            <div className="relative">
              <input
                ...
                {...register('email')}
                className={`w-full px-4 py-3 border-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-gold transition-colors bg-surface-light text-text-primary placeholder-silver-dark
                  ${errors.email ? 'border-red-500 bg-red-900/20' : touchedFields.email ? 'border-green-500 bg-green-900/20' : 'border-border-default'}`}
              />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="mb-1">
            ...
            <div className="relative">
              <input
                ...
                className={`w-full px-4 py-3 border-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-gold transition-colors bg-surface-light text-text-primary placeholder-silver-dark
                  ${errors.phone ? 'border-red-500 bg-red-900/20' : touchedFields.phone ? 'border-green-500 bg-green-900/20' : 'border-border-default'}`}
              />
          ...
          <div className="mb-1">
            <label htmlFor="address" className="block text-text-secondary font-medium mb-2 flex items-center">
            ...
            <div className="relative">
              <input
                ...
                className={`w-full px-4 py-3 border-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-gold transition-colors bg-surface-light text-text-primary placeholder-silver-dark
                  ${errors.address ? 'border-red-500 bg-red-900/20' : touchedFields.address ? 'border-green-500 bg-green-900/20' : 'border-border-default'}`}
              />
        ...
        <div className="mb-1">
          ...
          <select
            id="service"
            {...register('service')}
            className="w-full px-4 py-3 border-2 border-border-default rounded-lg focus:outline-none focus:ring-2 focus:ring-gold bg-surface-light text-text-primary"
          >
        ...
        <div className="mb-3">
          <label htmlFor="message" className="block text-text-secondary font-medium mb-2 flex items-center">
          ...
          <div className="relative">
            <textarea
              ...
              className={`w-full px-4 py-3 border-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-gold transition-colors resize-none bg-surface-light text-text-primary placeholder-silver-dark
                ${errors.message ? 'border-red-500 bg-red-900/20' : touchedFields.message ? 'border-green-500 bg-green-900/20' : 'border-border-default'}`}
            ></textarea>
        ...
        <div className="p-4 bg-surface-light rounded-lg border border-border-default mb-4">
        ...
        <div className="text-xs text-silver-dark border-t border-border-default pt-4 mb-6">
        ...
        <button
          ...
          className={`rounded-full px-8 py-4 font-medium w-full transition-all duration-300 text-lg shadow-md
            ${!isDirty || !isValid || !captchaVerified
              ? 'bg-surface-light text-silver-dark cursor-not-allowed'
              : 'bg-gold text-text-inverse hover:bg-gold-dark hover:shadow-lg'}`}
