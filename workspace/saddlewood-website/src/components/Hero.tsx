            ...
            <div className="flex items-center gap-4 mb-10">
              <div className="pl-4 border-l-2 border-gold/50">
                <p className="text-sm italic text-gray-300">
                  "Every detail intentional. Every home unforgettable."
                </p>
              </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link 
                ...
                className="group relative inline-flex items-center justify-center px-8 py-4 
                          border border-gold/50 text-white font-medium 
              ...
              >
                ...
                <svg className="w-5 h-5 mr-2 relative z-10 group-hover:text-gold transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
