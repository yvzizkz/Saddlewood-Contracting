...
export default function Hero() {
  return (
    <section className="relative py-20 sm:py-28 md:py-36 overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-[0.02] mix-blend-overlay bg-linen-texture pointer-events-none"></div>
      ...
      <div className="container-custom relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          <div className="lg:w-7/12">
            ...
            <h1 className="font-serif text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-semibold mb-6 leading-[1.05] text-primary">
            ...
            <p className="text-lg sm:text-xl mb-4 max-w-xl text-primary/70 leading-relaxed">
            ...
            <p className="text-base mb-8 max-w-xl text-taupe">
              Serving Paradise Valley, Scottsdale, Phoenix, and select communities throughout the Valley.
            </p>
            
            <div className="flex flex-wrap items-center gap-6 mb-10 p-5 bg-white/60 backdrop-blur-sm rounded-2xl border border-sandstone/50 shadow-soft">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-primary">Family-Owned</p>
                  <p className="text-xs text-taupe">Since 2007</p>
                </div>
              </div>
              <div className="h-10 w-px bg-sandstone hidden sm:block"></div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-primary">4 ROC Licenses</p>
                  <p className="text-xs text-taupe">Fully Insured</p>
                </div>
              </div>
              <div className="h-10 w-px bg-sandstone hidden sm:block"></div>
              <div className="pl-4 border-l-2 border-gold/40">
                <p className="text-sm italic text-primary/70">"Your vision, built right."</p>
              </div>
            </div>
          ...
          <div className="w-full lg:w-5/12">
            <div className="relative">
              ...
              <div className="relative bg-white p-6 sm:p-8 rounded-2xl border border-sandstone shadow-soft-lg backdrop-blur-sm">
                ...
                <div className="flex items-center mb-6">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-sage/30 to-sage/10 flex items-center justify-center mr-3 shadow-inner-soft">
                    <svg className="w-6 h-6 text-sage-dark" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path>
                    </svg>
                  </div>
                  <div>
                    <p className="text-sage-dark font-semibold text-sm uppercase tracking-wide">Fully Licensed & Insured</p>
                ...
                <div className="space-y-2.5 text-sm">
                  {[
                    ...
                    <div key={i} className="flex items-center justify-between p-3.5 bg-gradient-to-r from-ivory to-sandstone-light/50 rounded-xl border border-sandstone/30 hover:border-gold/30 transition-colors group">
                      <span className="text-primary font-medium">{item.service}</span>
                      <span className="text-gold font-semibold group-hover:text-gold-dark transition-colors">{item.roc}</span>
                    </div>
                  ))}
                </div>
                ...
                <div className="mt-6 pt-6 border-t border-sandstone">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="w-12 h-12 rounded-xl bg-ivory flex items-center justify-center">
                        <span className="text-gold text-xl font-serif font-bold">18+</span>
                      </div>
                      <div>
                        <p className="text-primary font-medium text-sm">Years of Excellence</p>
                        <p className="text-taupe text-xs">Serving Arizona Since 2007</p>
                      </div>
                    </div>
                    <div className="text-right">
                      <a href="tel:4809996100" className="text-gold font-bold text-lg hover:text-gold-dark transition-colors">(480) 999-6100</a>
