        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-5/12">
            <div className="bg-white bg-opacity-10 p-6 rounded-2xl border border-white border-opacity-20">
              <Skeleton className="bg-white bg-opacity-20 h-4 w-48 mb-4" />
              <Skeleton className="bg-white bg-opacity-20 h-4 w-full mb-2" />
              <Skeleton className="bg-white bg-opacity-20 h-4 w-full mb-2" />
              <Skeleton className="bg-white bg-opacity-20 h-4 w-full mb-2" />
              <Skeleton className="bg-white bg-opacity-20 h-4 w-full" />
            </div>
          </div>
        </div>
      </div>
