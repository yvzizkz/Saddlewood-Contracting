...
export default function LoadingAnimation() {
  ...
  return (
    <div className="fixed inset-0 bg-primary z-50 flex flex-col items-center justify-center overflow-hidden">
      {/* Particle container */}
      <div 
        ref={containerRef} 
      ...
      <div className="w-full max-w-md px-6 flex flex-col items-center relative z-10">
        ...
        <div className="mb-8">
          ...
          <div className="text-center">
            <div className="text-white text-3xl font-bold uppercase tracking-wider mb-1">
              Saddlewood
            </div>
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            {currentPhase === 0 && (
              ...
              <svg className="w-4/5 h-4/5" viewBox="0 0 200 150" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <circle cx="30" cy="40" r="3" fill="white" opacity="0.6" style={{ animation: 'pulse-glow 1.5s infinite' }}/>
                <circle cx="170" cy="40" r="3" fill="white" opacity="0.6" style={{ animation: 'pulse-glow 2s infinite' }}/>
                <circle cx="30" cy="120" r="3" fill="white" opacity="0.6" style={{ animation: 'pulse-glow 1.8s infinite' }}/>
                <circle cx="170" cy="120" r="3" fill="white" opacity="0.6" style={{ animation: 'pulse-glow 1.3s infinite' }}/>
              </svg>
            )}
            ...
            {currentPhase === 1 && (
              ...
              <svg className="w-4/5 h-4/5" viewBox="0 0 200 150" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <g style={{ animation: 'hammer 1.5s ease-in-out infinite', transformOrigin: '40px 90px' }}>
                  <rect x="35" y="80" width="10" height="30" fill="white" opacity="0.8" rx="2" />
                  <rect x="33" y="75" width="14" height="8" fill="white" opacity="0.9" rx="1" />
                </g>
                
                <g style={{ animation: 'drill 2s ease-in-out infinite' }}>
                  <rect x="150" y="80" width="20" height="10" fill="white" opacity="0.8" rx="2" />
                  <rect x="165" y="75" width="10" height="20" fill="white" opacity="0.7" rx="1" />
                </g>
              </svg>
            )}
            ...
            {currentPhase === 2 && (
              ...
              <svg className="w-4/5 h-4/5" viewBox="0 0 200 150" fill="none" xmlns="http://www.w3.org/2000/svg">
                {/* Foundation */}
                <rect x="20" y="120" width="160" height="10" fill="rgba(255,255,255,0.3)" />
                ...
                {/* Internal frames */}
                <line x1="50" y1="50" x2="50" y2="120" stroke="white" strokeWidth="2" />
                <line x1="90" y1="50" x2="90" y2="120" stroke="white" strokeWidth="2" />
                <line x1="110" y1="50" x2="110" y2="120" stroke="white" strokeWidth="2" />
                <line x1="150" y1="50" x2="150" y2="120" stroke="white" strokeWidth="2" />
                <line x1="30" y1="85" x2="170" y2="85" stroke="white" strokeWidth="2" />
                
                {/* Construction worker indicator */}
                <circle cx="70" cy="70" r="5" fill="yellow" opacity="0.8" style={{ animation: 'pulse-glow 1.5s infinite' }} />
                <circle cx="130" cy="95" r="5" fill="yellow" opacity="0.8" style={{ animation: 'pulse-glow 2s infinite' }} />
              </svg>
            )}
            ...
            {currentPhase === 3 && (
              ...
              <svg className="w-4/5 h-4/5" viewBox="0 0 200 150" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <g style={{ animation: 'drill 1.5s ease-in-out infinite', transformOrigin: '120px 85px' }}>
                  <rect x="110" y="80" width="20" height="10" fill="white" opacity="0.8" rx="2" />
                  <rect x="125" y="75" width="5" height="20" fill="white" opacity="0.7" rx="1" />
                </g>
              </svg>
            )}
            ...
            {currentPhase === 4 && (
              ...
              <svg className="w-4/5 h-4/5" viewBox="0 0 200 150" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                {/* Finishing details */}
                <circle cx="100" cy="100" r="3" fill="white" opacity="0.9" style={{ animation: 'pulse-glow 1s infinite' }} />
          ...
          <div className="absolute bottom-0 left-0 w-full flex justify-between items-center px-4 opacity-70">
            ...
            >
              <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="30" height="30">
                <path d="M15,12L5.5,18V6L15,12Z" fill="white" />
        ...
        <div className="w-full bg-black bg-opacity-40 rounded-full h-3 mb-4 p-0.5">
          <div 
        ...
        {/* Saddlewood tagline */}
        <div className="absolute bottom-4 text-gray-400 text-xs tracking-widest text-center w-full">
