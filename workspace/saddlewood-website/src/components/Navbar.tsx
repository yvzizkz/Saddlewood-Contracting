    ...
    <header className="bg-warmwhite sticky top-0 z-50 border-b border-sandstone/30">
      ...
      <nav className="py-3 sm:py-4">
        <div className="container-custom">
          ...
          <div 
            className={`md:hidden fixed inset-0 z-40 bg-primary/80 backdrop-blur-sm transition-opacity duration-300 ${
          ...
          <div 
            className={`md:hidden fixed right-0 top-0 bottom-0 w-[280px] z-50 bg-warmwhite shadow-soft-xl transition-transform duration-300 transform ${
