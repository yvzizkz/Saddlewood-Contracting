        ...
        <div className="container-custom relative z-10 py-16 md:py-24">
          <div className="max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a 
                href="#contact" 
                className="px-8 py-4 bg-accent hover:bg-accent-dark text-white font-medium rounded-full
              ...
              <a 
                ...
                className="px-8 py-4 bg-white text-primary hover:bg-gray-100 font-medium rounded-full
                          transition-all duration-300 shadow-lg hover:shadow-xl text-center
                          transform hover:scale-105 inline-flex items-center justify-center"
              >
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {benefits.map((benefit, index) => (
              <div key={index} className="bg-white rounded-xl shadow-md p-6 transition-transform duration-300 hover:scale-105">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-xl shadow-md p-8 flex flex-col md:flex-row">
              <div className="flex-shrink-0 mb-6 md:mb-0 md:mr-6">
                <div className="bg-primary text-white text-center px-4 py-3 rounded">
