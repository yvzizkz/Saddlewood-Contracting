...
export default function VideoShowcase() {
  ...
  return (
    <section className="py-20 bg-gradient-to-b from-ivory via-cream to-ivory relative overflow-hidden">
      {/* Decorative Elements */}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="font-playfair text-3xl sm:text-4xl text-primary mb-4">
        ...
        <div className="relative group">
          ...
          <div className="relative bg-white rounded-2xl shadow-soft-lg overflow-hidden border border-sandstone">
            {/* Gold accent bar at top */}
            <div className="h-1 bg-gradient-to-r from-gold/40 via-gold to-gold/40"></div>
            
            {/* Video wrapper */}
            <div className="relative aspect-[9/16] sm:aspect-video bg-primary/5">
              <video
                ref={videoRef}
            ...
            {/* Bottom info bar */}
            <div className="px-6 py-4 bg-gradient-to-r from-cream via-ivory to-cream border-t border-sandstone/50">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-primary">Saddlewood Contracting</p>
                    <p className="text-xs text-taupe">Quality craftsmanship since 2007</p>
                  </div>
                </div>
        ...
        <div className="text-center mt-8">
          <p className="text-taupe text-sm mb-3">Follow us for more project updates and behind-the-scenes content</p>
          <a 
            href="https://www.instagram.com/saddlewood_contracting" 
            target="_blank" 
            rel="noopener noreferrer"
